...
const Footer = () => {
  ...
  return (
    <div className='scroll-smooth dark:border-t-2 dark:border-slate-500/30 dark:bg-theme_dark-main-bg flex-wrap relative gap-20 flex justify-center items-end  bg-white w-full pt-12 pb-8'>
