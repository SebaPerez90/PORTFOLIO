...
const Experience = () => {
  ...
  return (
    <>
      <section className='shadow-[14px_30px_20px_-10px_#0000004f] py-20 px-32 w-[80%] bg-white rounded-lg'>
        <h1
        ...
        <article className=' shadow-[14px_30px_20px_-10px_#0000004f] gap-6 flex flex-col items-center self-center mt-32 bg-[#eeeeee] py-12 px-6 rounded-lg'>
          <h1 className='text-[#333333ac] text-3xl font-extrabold text-center'>
            <strong className='text-red-400'>SPOILER ALERT! </strong>- Mucho
            texto 😅
          </h1>
          ...
          <div ref={boxRef} className='[display:none]'>
            <h1 className='text-light-800 [letter-spacing:8px] text-3xl font-extrabold text-center'>
              Conclusión
            </h1>
            ...
            <div className='bg-light-800  p-8 mt-4 rounded-md font-semibold text-white'>
              <p>
                {engLanguageActive
      ...
      <section className='bg-white py-20 flex flex-col items-center gap-28'>
          ...
          <article className='max-[950px]:h-[20em] max-[950px]:flex-row  max-[950px]:w-[80%]  h-[25em] w-[16em] flex justify-between  items-center flex-col'>
            ...
            <div className='z-10 relative before:absolute before:w-24 before:h-[1px] before:top-0 before:left-[-1.2em] before:-z-10 before:bg-black before:rotate-[90deg] w-14 h-14 max-[950px]:before:rotate-[0deg] max-[950px]:before:left-[-4.2em] max-[950px]:before:top-7'>
              <Image
                ...
                alt='soyHenry-logo'
                priority
                className='border-2 border-light-800 w-full h-full object-cover rounded-full'
              />
            </div>
          </article>
