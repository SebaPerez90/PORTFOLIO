...
const Avatar = () => {
  ...
  return (
    <div className='max-[520px]:h-[12em] max-[520px]:pb-7 max-[520px]:items-end max-[520px]:justify-start max-[520px]:w-full max-[520px]:right-0 max-[520px]:relative xl:w-[45em] dark:[background:linear-gradient(to_right,#00000000,#00000000)] max-[700px]:absolute max-[700px]:right-36 flex items-end justify-end self-end lg:bg-gradient-to-l from-light-500 to-[#DCBFFF] h-[40em] w-[38em] z-40'>
      ...
      <div className='gap-6 max-[520px]:translate-x-[0] max-[520px]:flex-row max-[520px]:h-auto z-10 flex flex-col items-center justify-evenly max-[700px]:translate-x-[11em] h-[22em]'>
