...
const Proyects = () => {
  ...
  return (
    <section
      ...
      <h1 className=' dark:text-slate-50 text-4xl font-black text-[#334155] text-left'>
      ...
      <div className='flex-wrap flex flex-row justify-center w-[80%] gap-24'>
        {projects.map((element, index) => (
          <motion.div
            ...
            <div>
              <div className='flex flex-col gap-5 w-[25em] [min-height:20em] h-auto justify-evenly p-[1em_2em] rounded-md bg-white border border-slate-200 [box-shadow:7px_9px_9px_-3px_rgba(0,0,0,0.16)] dark:bg-dark-main dark:border-slate-700'>
                <div>
                  <h1 className='font-bold text-center text-xl dark:text-dark-sky'>
                    {element.title}
                  </h1>
                ...
                <div className='flex justify-center gap-12'>
                  <Link
                    className='bg-light-500 p-3 text-slate-50 rounded-md text-xs font-bold hover:bg-light-400 duration-200 hover:duration-200 active:scale-95 dark:bg-dark-sky flex items-center'
