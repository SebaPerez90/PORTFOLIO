...
import addSvgIcon from '@/components/services&skills/Icon';
...
const Proyects = () => {
  ...
  return (
    <section
      ...
      <h1
        className='dark:text-slate-50 text-4xl min-[500px]:[letter-spacing:10px] text-[#334155]'
        style={roboto.style}>
      ...
      {projects.map((item, index) => (
        <div
          ...
          <article className='dark:bg-theme_dark-main-bg relative rounded-none md:rounded-[0.5em_0_0_0.5em] gap-12 flex flex-col justify-around items-center bg-white w-full py-8'>
            <h2
              className='dark:text-theme_dark-sup-sky px-2 text-4xl text-center font-extrabold text-[#334155]'
              style={roboto.style}>
              {item.title}
            </h2>
          ...
          <article className='dark:bg-theme_dark-main-bg pb-8 pt-24 sm:pt-0 sm:pb-0 w-full flex justify-center bg-gradient-to-l from-light-100 to-white items-center rounded-none md:rounded-[0_0.5em_0.5em_0] dark:from-transparent dark:to-transparent'>
