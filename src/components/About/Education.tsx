...
const Education = () => {
  ...
  return (
    <section className='dark:bg-theme_dark-main-bg bg-white py-28 flex flex-col items-center gap-28 w-[95%] sm:w-[80%] shadow-[14px_30px_20px_-10px_#0000004f] rounded-lg'>
      ...
      <div className=' max-[460px]:w-[85%] dark:border-t dark:border-r dark:border-b dark:border-r-slate-500/30 dark:border-t-slate-500/30 dark:border-b-slate-500/30  border-l-[12px] border-[#f0e244] dark:bg-theme_dark-box-second px-6 py-8 bg-[#ededed] max-[650px]:w-[80%] max-[950px]:w-[90%] flex flex-col items-center w-[60%] rounded-[0_0.4em_0.4em_0]'>
