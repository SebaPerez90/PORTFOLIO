...
const NavBar = () => {
  ...
  return (
    <header className='z-50 duration-300 w-full  bg-transparent flex justify-center fixed'>
      <nav
        id='nav-bar'
        className='z-50 top-2 relative border border-slate-500/10 rounded-full bg-[#eeeeee81] dark:bg-[#0000004a] min-w-max py-2 px-3 duration-300 flex items-center dark:border dark:border-slate-500/30'>
